...
<div class="game-container">
    <div class="game-card">
        ...
        <div class="game-table">
            <h4 class="text-center text-white mb-4">Predict if the next number will be in the 0-49 or 50-99 range!</h4>
            ...
            <div class="prediction-buttons" id="predictionButtons" style="display:none">
                <button class="predict-btn" onclick="predict('low')">0-49 (2x)</button>
                <button class="predict-btn" onclick="predict('high')">50-99 (2x)</button>
            </div>
        </div>
